    ...
    return (
        <div className="container h-full">
            ...
            <section className="mt-2">
                <h2 className="text-center text-xl ">Chapitre 2 : La Création de PetitePatteStyle</h2>
                <p className="mt-2">
                    Roxana se lança dans des recherches approfondies sur les besoins spécifiques des petits chiens. Elle
                    consulta des vétérinaires, des designers de mode et des couturiers spécialisés pour comprendre les
                    meilleures matières et coupes pour le confort et la mobilité des chiens. Avec des esquisses en main
                    et une vision claire, elle commença à concevoir ses premiers prototypes. Après de nombreux essais et
                    ajustements, elle créa une gamme de vêtements alliant style, confort et praticité.
                </p>
            </section>
            <hr className="mt-4"/>
            <section className="mt-2">
