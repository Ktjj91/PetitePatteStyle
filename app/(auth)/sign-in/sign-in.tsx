...
export function SignIn() {
    ...
    return (
        <div className="container mt-5 flex flex-col items-center  space-y-4 h-screen ">
            ...
            <p className="text-[0.7em] ">En continuant, vous acceptez les <Link className=" text-blue-500 hover:underline"  href="/">conditions génerale de PetitePatteStyle</Link> et confirmez que vous avez lu la <Link  className="text-blue-500 hover:underline" href="/">politique de confidentialité de PetitePatteStyle.</Link></p>
            ...
            <div className=" mt-5 flex flex-col items-center justify-center gap-y-3">
                ...
                <Link className="hover:underline" href="/register">Inscrivez vous !</Link>
            </div>
        </div>
    )
}
